...
This Unity project was created as part of the Steer Elite Internship Program's Tech UI Skills Assessment (2025 Cohort). The goal of the project is to replicate a given UI layout using Unity’s built-in UI system — focusing on interaction, animation, responsiveness, and layout quality.
...
##  Above and Beyond (Optional Additions)

- Implemented **Safe Area Controller** to avoid overlap with phone camera notches.
- Created animated **hand element** for extra visual polish.
- Added **scrolling background** to bring movement to the UI.
- Carefully tuned layout to match provided design.
